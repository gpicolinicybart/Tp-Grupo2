...
if __name__ == "__main__":
    try:
        ...
        print("Estado inicial:", operario_1)
        
        tarea, duracion = "Soldadura", 5.0
        print(f"\nEvaluando asignación de tarea automática (Requiere {tarea}, {duracion}hs)...")
...
if __name__ == "__main__":
    try:
        ...
        # Producto ya definido en el sistema (no es parte del flujo del caso)
